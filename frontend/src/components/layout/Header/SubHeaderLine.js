...
function SubHeaderLine(props) {
  return (
    <>
      <div className="relative pt-3 transition-all duration-300 h-full   hover:transition-all hover:duration-300 text-start hover:px-5 text-black hover:text-[#ff324d]     mt-5">
